...
double massimoTra(double a, double b)
{
	if(a > b)
	{
		return a;
...
double minimoVec(std::vector<double> vec)
{
	double min = vec.at(0);
...
double massimoVec(std::vector<double> vec)
{
	double max = vec.at(0);
...
double pdf_esponenziale(double t, double t_0)
{
	if (t_0 == 0.0)
	{
		return 1;
