...
double massimoTra(double a, double b); // Determina il massimo tra due valori
...
double minimoVec(std::vector<double> vec); // Determina il minimo di un vector di double
double massimoVec(std::vector<double> vec); // Determina il massimo di un vector di double
